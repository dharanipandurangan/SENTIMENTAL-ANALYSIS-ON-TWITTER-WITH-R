...
pos.words = scan('C:/TWITTER/p_words.txt',what='character',comment.char=';') 
neg.words = scan('C:/TWITTER/n_words.txt',what='character',comment.char=';')
...
bscore <- score.sentiment(tweet_df$text,pos.words,neg.words,.progress='text')  # refers BARCELONA
rscore <- score.sentiment(tweet2_df$text,pos.words,neg.words,.progress='text') # refers REAL MADRID
